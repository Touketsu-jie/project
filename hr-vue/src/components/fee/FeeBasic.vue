    ...
    <el-container>
      <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
        <div style="display: inline">
          ...
          <el-button type="primary" size="mini" style="margin-left: 5px" icon="el-icon-search" @click="searchRequestFees">搜索
          </el-button>
        </div>
      ...
      <el-main style="padding-left: 0px;padding-top: 0px">
        <div>
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button @click="showDetailFeeRequestResource(scope.row)" style="padding: 3px 4px 3px 4px;margin: 2px"
                           size="small">详细
                </el-button>
              </template>
            </el-table-column>
          ...
          <div style="display: flex;justify-content: space-between;margin: 2px">
            <!-- <el-button type="danger" size="mini" v-if="prjResources.length>0" :disabled="multipleSelection.length==0"
...
//        document.body.appendChild(iframe);
      ...
      loadRequestFees(){
        var _this = this;
        this.tableLoading = true;
        this.getRequest("/fee/request/list?page=" + this.currentPage + "&size=10&keywords=" + this.keywords+ "&month=" + this.month).then(resp=> {
          this.tableLoading = false;
          if (resp && resp.status == 200) {
            var data = resp.data;
            _this.prjResources = data.prjResources;
